...
const Footer = () => {
  return (
    <footer
      ...
      font-medium text-lg justify-between flex items-center pr-16 md:px-16 sm:px-8
      sm:text-base lg:flex-col z-10"
    >
      <Layout className="left-0 py-8 flex items-center justify-between lg:flex-col lg:py-6 md:py-4 sm:py-2">
        <span>{new Date().getFullYear()} &copy; Mohammadreza Asherloo</span>
      </Layout>

      <div className="py-8 z-10 flex items-center justify-between col-auto lg:py-2 md:pb-3">
        <motion.a
